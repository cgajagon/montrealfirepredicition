...
from .nodes import create_square_mesh, spatial_join_incidents, spatial_join_property_assessments, spatial_join_census, merge_incidents_property_assessments, merge_incidents_property_assessments_census, create_input_table
...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline([
        ...
        node(
            ...
            inputs=["spatial_joined_incidents", "spatial_joined_property_assessments"],
        ...
        node(
            ...
            inputs=["merged_incidents_property_assessments", "spatial_joined_census"],
        ...
        node(
            ...
            inputs=["merged_incidents_property_assessments_census", "preprocessed_firestations"],
            outputs="input_table",
